...
int main(){
    ...
    int N = 150; // total number of items
    ...
    std::cout << "Since the input is randomly generated, sometimes it can take quite some time for the brute force algorithm to run.\n";
